...
public class KampanieDAO {
    ...
    public int saveKampanie(Kampanie kampanie) {
        String sql = "INSERT INTO Kampanie (Id_kampanii, Nazwa, Opis, Data_rozpoczecia, Data_zakonczenia, Budzet, Id_klienta, Id_biura) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        return jdbcTemplate.update(sql, kampanie.getIdKampanii(), kampanie.getNazwa(), kampanie.getOpis(), kampanie.getDataRozpoczecia(), kampanie.getDataZakonczenia(), kampanie.getBudzet(), kampanie.getIdKlienta(), kampanie.getIdBiura());
    }
